        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center gap-2.5">
              <div className="w-7 h-7 rounded-sm bg-accent text-accent-fg font-mono font-bold text-xs flex items-center justify-center tracking-tighter">
                PX
              </div>
            ...
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-bg-elevated border border-border-subtle text-[11px] font-mono text-fg-muted">
              <span
