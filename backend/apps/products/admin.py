...
from .models import Brand, Product, ProductVariant, ProductImage, ProductAttributeValue
...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'category', 'brand', 'product_type', 'base_price', 'is_active', 'is_featured')
    ...
    fieldsets = (
        (None, {
            'fields': ('name', 'slug', 'product_type', 'is_active', 'is_featured')
        }),
        ('Organization', {
