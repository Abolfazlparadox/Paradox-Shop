...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-bg-primary">
      ...
      <section className="relative py-16 sm:py-24 border-b border-border-subtle overflow-hidden bg-grid-pattern">
        ...
        <Container size="lg" className="relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex items-center justify-center relative">
              <div className="w-full max-w-md bg-bg-elevated/40 border border-border-subtle/70 rounded-2xl p-4 backdrop-blur-sm shadow-card">
                <PenroseHero3D />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {categoryTree?.map((cat) => (
              <Link
                ...
                className="group flex flex-col justify-between p-6 bg-bg-elevated border border-border-subtle rounded-lg hover:border-border-accent hover:shadow-card transition-all"
              >
                <div className="space-y-2">
                  <span className="w-10 h-10 rounded-md bg-bg-secondary border border-border-subtle flex items-center justify-center text-fg-primary mb-4 font-mono text-xs font-bold group-hover:scale-105 transition-transform">
        ...
        <Container size="lg">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 space-y-6">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold font-display text-fg-primary tracking-tight leading-tight">
            ...
            <div className="lg:col-span-6 bg-bg-elevated border border-border-subtle rounded-2xl p-8 space-y-6">
