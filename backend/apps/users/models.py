...
from common.models import UUIDPrimaryKeyMixin, TimestampMixin, SoftDeleteMixin
...
class Address(UUIDPrimaryKeyMixin, TimestampMixin, SoftDeleteMixin):
    ...
    title = models.CharField(max_length=100, help_text=_('e.g. Home, Work'), verbose_name=_('Title'))
